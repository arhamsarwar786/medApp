...
//     XFile? camra = await _picker.pickImage(dlsource: ImageSource.camera);
//     setState(() {
//       _camra = camra;
//     });
//   }`\k
...
//                       onPressed: () async {
//                         try {
//                         print("####################### $name $picked $price ${auth.currentUser!.uid}");
                          ...
                          //   'request': false
                          // })
//                           .then((value) => Get.snackbar("Submitted", "Success")).then((value) => Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>UserScreen())));
//                         } catch (e) {
//                           print(e);
//                         }
//                         nameMed.clear();
          ...
          Scaffold.of(context).showSnackBar(SnackBar(content: Text('Profile Picture Uploaded')));
                          ...
                          reference.add({
                            ...
                            'request': false
                              ...
                              .catchError((onError) {
                                Get.snackbar(
                                    "Error Not Submitted", onError.message);
                              });
                        } catch (e) {
                          print(e);
                        }
